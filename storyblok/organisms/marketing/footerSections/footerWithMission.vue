      ...
      <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
        <p class="text-xs leading-5 text-gray-400">
          ...
          <a
            target="_blank"
            class="underline"
            href="https://www.therosestudio.es/"
            >The Rose Studio</a
          >
        </p>
      </div>
...
const navigation = {
  support: [
    ...
    { name: "Sé lo que tu quieras", href: "/se-lo-que-quieras" },
    { name: "Ser independiente", href: "/ser-independiente" },
    { name: "Aprende cosas nuevas", href: "/aprende-cosas-nuevas" },
  ],
  company: [
    { name: "Juventud Güímar News", href: "/juventud-guimar-news" },
    { name: "Arrímate a la casa", href: "/arrimate-a-la-casa" },
