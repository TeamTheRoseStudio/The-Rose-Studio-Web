...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const story = ([__temp, __restore] = withAsyncContext(() => useAsyncStoryblok("layout/header", {
      version: "draft"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/layout/header.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=header-b529ec22.mjs.map
