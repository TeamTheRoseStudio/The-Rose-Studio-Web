...
const _sfc_main = {
  __name: "cardCaroussel",
  __ssrInlineRender: true,
  props: { blok: Object },
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_editable = resolveDirective("editable");
      _push(`<div${ssrRenderAttrs(mergeProps(_attrs, ssrGetDirectiveProps(_ctx, _directive_editable, __props.blok)))}><div id="default-carousel" class="relative w-full" data-carousel="slide"><div class="caroussel-container relative mx-10 w-full overflow-hidden rounded-lg"><!--[-->`);
      ssrRenderList(__props.blok.cards, (card, index) => {
        _push(`<div class="hidden duration-700 ease-in-out" data-carousel-item><div${ssrRenderAttr("blok", card)} class="absolute block h-full w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"><div>${ssrInterpolate(__props.blok.title)}</div></div></div>`);
      });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("storyblok/molecules/cardCaroussel.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=cardCaroussel-95693273.mjs.map
